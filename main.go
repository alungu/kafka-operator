...
func main() {
	...
	if namespaces != "" {
		...
		// always append empty namespace to watch cluster-scoped resources
		// e.g. Nodes' labels are queried as part of broker rack-awareness setup
		managerWatchCache = cache.MultiNamespacedCacheBuilder(append(ns, ""))
	}
